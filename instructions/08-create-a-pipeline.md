---
lab:
  title: Erstellen einer Pipeline
ms.openlocfilehash: d76c9c66876fcb03aa02d48ee47ae92e327dd8c9
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: de-DE
ms.lasthandoff: 11/17/2021
ms.locfileid: "132832597"
---
# <a name="create-a-pipeline"></a>Erstellen einer Pipeline

Mit dem Azure Machine Learning SDK können Sie alle Aufgaben ausführen, die zum Erstellen und Betreiben einer Machine Learning-Lösung in Azure erforderlich sind. Anstatt diese Aufgaben einzeln auszuführen, können Sie *Pipelines* verwenden, um die erforderlichen Schritte zum Vorbereiten von Daten, Ausführen von Trainingsskripts, Registrieren von Modellen und andere Aufgaben zu orchestrieren.
...
## <a name="create-and-publish-a-pipeline"></a>Erstellen und Veröffentlichen einer Pipeline

In dieser Übung wird der Code zum Erstellen und Veröffentlichen einer Pipeline in einem Notebook bereitgestellt.

1. Navigieren Sie auf der Jupyter-Startseite zum Ordner **/users/*Ihr-Benutzername*/mslearn-dp100**, in dem Sie das Notebook-Repository geklont haben, und öffnen Sie das Notebook **Create a Pipeline** (Erstellen einer Pipeline).
